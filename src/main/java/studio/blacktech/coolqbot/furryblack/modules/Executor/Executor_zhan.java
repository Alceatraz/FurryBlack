...
public class Executor_zhan extends ModuleExecutor {
	...
	@Override public boolean init() throws Exception {
		...
		CARD.put(1, "O. THE FOOL 愚者正位\r\n愚蠢 狂躁 挥霍无度 神志不清");
		CARD.put(2, "O. THE FOOL 愚者逆位\r\n疏忽 缺乏 暮气 无效 虚荣");
		CARD.put(3, "I. THE MAGICIAN 魔术师正位\r\n手段 灾难 痛苦 损失");
		CARD.put(4, "I. THE MAGICIAN 魔术师逆位\r\n羞辱 忧虑 精神疾病");
		CARD.put(5, "II. THE HIGH PRIESTESS 女祭司正位\r\n秘密 神秘 未来不明朗 英明");
		CARD.put(6, "II. THE HIGH PRIESTESS 女祭司逆位\r\n冲动 狂热 自负 浮于表面");
		CARD.put(7, "III. THE EMPRESS 皇后正位\r\n丰收 倡议 隐秘 困难 无知");
		CARD.put(8, "III. THE EMPRESS 皇后逆位\r\n光明 真相 喜悦");
		CARD.put(9, "IV. THE EMPEROR 皇帝正位\r\n稳定 力量 帮助 保护 信念");
		CARD.put(10, "IV. THE EMPEROR 皇帝逆位\r\n仁慈 同情 赞许 阻碍 不成熟");
		CARD.put(11, "V. THE HIEROPHANT 教皇正位\r\n宽恕 束缚 奴役 灵感");
		CARD.put(12, "V. THE HIEROPHANT 教皇逆位\r\n善解人意 和睦 过度善良 软弱");
		CARD.put(13, "VI. THE LOVERS 恋人正位\r\n吸引 爱 美丽 通过试炼");
		CARD.put(14, "VI. THE LOVERS 恋人逆位\r\n失败 愚蠢的设计");
		CARD.put(15, "VII. THE CHARIOT 战车正位\r\n救助 天意 胜利 复仇");
		CARD.put(16, "VII. THE CHARIOT 战车逆位\r\n打败 狂暴 吵架 诉讼");
		CARD.put(17, "VIII. THE STRENGTH 力量正位\r\n能量 行动 勇气 海量");
		CARD.put(18, "VIII. THE STRENGTH 力量逆位\r\n专断 弱点 滥用力量 不和");
		CARD.put(19, "IX. THE HERMIT 隐者正位\r\n慎重 叛徒 掩饰 堕落 恶事");
		CARD.put(20, "IX. THE HERMIT 隐者逆位\r\n隐蔽 害怕 伪装 过分小心");
		CARD.put(21, "X. THE WHEEL OF FORTUNE 命运之轮正位\r\n命运 好运 成功 幸福");
		CARD.put(22, "X. THE WHEEL OF FORTUNE 命运之轮逆位\r\n增加 丰富 多余");
		CARD.put(23, "XI. THE JUSTICE 正义正位\r\n公平 正义 廉洁 行政");
		CARD.put(24, "XI. THE JUSTICE 正义逆位\r\n偏执 不公 过度俭朴");
		CARD.put(25, "XII. THE HANGED MAN 吊人正位\r\n智慧 牺牲 审判 细心 眼光");
		CARD.put(26, "XII. THE HANGED MAN 吊人逆位\r\n自私 群众 人民");
		CARD.put(27, "XIII. DEATH 死亡正位\r\n终结 死亡 毁灭 腐朽");
		CARD.put(28, "XIII. DEATH 死亡逆位\r\n惯性 石化 梦游 昏 睡");
		CARD.put(29, "XIV. TEMPERANCE 节制正位\r\n经济 适度 节俭 管理 住所");
		CARD.put(30, "XIV. TEMPERANCE 节制逆位\r\n教会 分离 不幸的组合 冲突的利益");
		CARD.put(31, "XV. THE DEVIL 恶魔正位\r\n毁坏 暴力 强迫 愤怒 额外努力 死亡");
		CARD.put(32, "XV. THE DEVIL 恶魔逆位\r\n死亡 弱点 盲目 琐事");
		CARD.put(33, "XVI. THE TOWER 高塔正位\r\n苦难 废墟 贫乏 耻辱 灾害 逆境 骗局");
		CARD.put(34, "XVI. THE TOWER 高塔逆位\r\n专断 监禁 受苦 损害");
		CARD.put(35, "XVII. THE STAR 星星正位\r\n丢失 窃贼 匮乏 放弃 未来的希望");
		CARD.put(36, "XVII. THE STAR 星星逆位\r\n傲慢 无能 傲气");
		CARD.put(37, "XVIII. THE MOON 月亮正位\r\n隐藏的敌人 诽谤 危险 黑暗 恐怖 错误");
		CARD.put(38, "XVIII. THE MOON 月亮逆位\r\n不稳定 易变 骗局 错误");
		CARD.put(39, "XIX. THE SUN 太阳正位\r\n喜悦 结婚 满意");
		CARD.put(40, "XIX. THE SUN 太阳逆位\r\n开心 满意");
		CARD.put(41, "XX. THE LAST JUDGMENT 审判正位\r\n变位 复兴 结果");
		CARD.put(42, "XX. THE LAST JUDGMENT 审判逆位\r\n弱点 胆怯 天真 决定 熟虑");
		CARD.put(43, "XXI. THE WORLD 世界正位\r\n成功 道路 航程 换位");
		CARD.put(44, "XXI. THE WORLD 世界逆位\r\n惯性 固执 停滞 持久");

		// @formatter:off
		FREQ.add(0);        FREQ.add(0);        FREQ.add(0);        FREQ.add(0);        FREQ.add(0);
		FREQ.add(0);        FREQ.add(0);        FREQ.add(0);        FREQ.add(0);        FREQ.add(0);
		FREQ.add(0);        FREQ.add(0);        FREQ.add(0);        FREQ.add(0);        FREQ.add(0);
		FREQ.add(0);        FREQ.add(0);        FREQ.add(0);        FREQ.add(0);        FREQ.add(0);
		FREQ.add(0);        FREQ.add(0);        FREQ.add(0);        FREQ.add(0);        FREQ.add(0);
		...
		FREQ.add(0);        FREQ.add(0);        FREQ.add(0);        FREQ.add(0);        FREQ.add(0);
		FREQ.add(0);        FREQ.add(0);        FREQ.add(0);        FREQ.add(0);        FREQ.add(0);
		FREQ.add(0);        FREQ.add(0);        FREQ.add(0);        FREQ.add(0);        // @formatter:on
	...
	@Override public boolean doUserMessage(int typeid, long userid, MessageUser message, int messageid, int messagefont) throws Exception {
		if (message.getSection() == 0) {
			...
			builder.append(" 抽到了：\r\n");
			builder.append(CARD.get(urandom));
			FREQ.set(urandom, FREQ.get(urandom) + 1);
