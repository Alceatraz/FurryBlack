...
public class Trigger_UserDeny extends ModuleTrigger {
	...
	public boolean init() throws Exception {
		...
		ENABLE_DISZ = ENABLE_USER || (ENABLE_DISZ && ((DISZ_IGNORE.size() + DISZ_IGNORE_ONE.size()) > 0));
		ENABLE_GROP = ENABLE_USER || (ENABLE_GROP && ((GROP_IGNORE.size() + GROP_IGNORE_ONE.size()) > 0));
