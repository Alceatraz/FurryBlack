...
public class RandomTool {
	...
	public static String randomStringUPPER(int length) {
		...
		for (int i = 0; i < length; i++) {
			chat[i] = UPPER_CHAR.charAt(secureRandom.nextInt(25));
		}
		return new String(chat);
	...
	public static String randomString(int length) {
		...
		char[] chat = new char[length];
		for (int i = 0; i < length; i++) {
			chat[i] = EN_US_CHAR.charAt(secureRandom.nextInt(51));
		}
		return new String(chat);
	...
	public static String randomStringDEC(int length) {
		...
		char[] chat = new char[length];
		for (int i = 0; i < length; i++) {
			chat[i] = EN_US_NUMB.charAt(secureRandom.nextInt(61));
		}
		return new String(chat);
	...
	public static String randomStringBASE64(int length) {
		...
		char[] chat = new char[length];
		for (int i = 0; i < length; i++) {
			chat[i] = BASE64.charAt(secureRandom.nextInt(63));
		}
		return new String(chat);
